package com.snuggles.android.systemui.keyguard;
...
import com.snuggles.android.systemui.smartspace.SmartSpaceCard;
import com.snuggles.android.systemui.smartspace.SmartSpaceController;
import com.snuggles.android.systemui.smartspace.SmartSpaceData;
import com.snuggles.android.systemui.smartspace.SmartSpaceUpdateListener;
...
public class KeyguardSliceProviderSnuggles extends KeyguardSliceProvider
    ...
    public Slice onBindSlice(Uri uri) {
        Trace.beginSection("KeyguardSliceProviderSnuggles#onBindSlice");
        ...
        synchronized (this) {
            ...
            if (currentCard != null
                ...
                boolean z2 =
                        isSensitive && !this.mHideSensitiveContent && !currentCard.isWorkProfile();
            ...
            if (z) {
                ...
                IconCompat createWithBitmap =
                        icon == null ? null : IconCompat.createWithBitmap(icon);
                PendingIntent pendingIntent = currentCard.getPendingIntent();
                if (createWithBitmap != null && pendingIntent != null) {
                    sliceAction =
                            SliceAction.create(
                                    pendingIntent, createWithBitmap, 1, currentCard.getTitle());
                }
                ListBuilder.HeaderBuilder title =
                        new ListBuilder.HeaderBuilder(this.mHeaderUri)
                                .setTitle(currentCard.getFormattedTitle());
                if (sliceAction != null) {
                ...
                if (subtitle != null) {
                    ListBuilder.RowBuilder title2 =
                            new ListBuilder.RowBuilder(this.mCalendarUri).setTitle(subtitle);
            ...
            if (needsMediaLocked()) {
                ...
                listBuilder.addRow(
                        new ListBuilder.RowBuilder(this.mDateUri)
                                .setTitle(getFormattedDateLocked()));
            }
    ...
    private void addWeather(ListBuilder listBuilder) {
        ...
        ListBuilder.RowBuilder title =
                new ListBuilder.RowBuilder(this.mWeatherUri).setTitle(weatherCard.getTitle());
    ...
    public void onSmartSpaceUpdated(SmartSpaceData smartSpaceData) {
        ...
        if (weatherCard != null
                && weatherCard.getIcon() != null
                && !weatherCard.isIconProcessed()) {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<KeyguardSliceProviderSnuggles> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(
                KeyguardSliceProviderSnuggles keyguardSliceProviderSnuggles,
                SmartSpaceCard smartSpaceCard) {
            this.mProviderReference = new WeakReference<>(keyguardSliceProviderSnuggles);
            this.mWeatherCard = smartSpaceCard;
            this.mBlurRadius =
                    keyguardSliceProviderSnuggles
                            .getContext()
                            .getResources()
        ...
        public void onPostExecute(Bitmap bitmap) {
            ...
            synchronized (this) {
                ...
                keyguardSliceProviderSnuggles = this.mProviderReference.get();
            }
            if (keyguardSliceProviderSnuggles != null) {
                keyguardSliceProviderSnuggles.notifyChange();
            }
        }

        private Bitmap applyShadow(Bitmap bitmap) {
            BlurMaskFilter blurMaskFilter =
                    new BlurMaskFilter(this.mBlurRadius, BlurMaskFilter.Blur.NORMAL);
            ...
            paint2.setAlpha(70);
            canvas.drawBitmap(extractAlpha, iArr[0], iArr[1] + (this.mBlurRadius / 2.0f), paint2);
